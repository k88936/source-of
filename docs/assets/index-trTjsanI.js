...
`}},async created(){},methods:{goHome(){this.$router.push("/")},navigateToVersion(i){this.$router.push(`/${this.packageInfo.name}/${i}`)},viewLatest(){this.navigateToVersion(this.packageInfo.latestVersion)},formatDate(i){return new Date(i).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"})}}},M={class:"package-page"},R={class:"package-header"},D={class:"header-nav"},U={class:"header-content"},K={class:"package-info"},O={class:"package-details"},z={class:"package-actions"},B={class:"version-list"},G=["onClick"],V={class:"version-info"},Y={class:"version-header"},L={class:"version-meta"},F={class:"version-date"},P={class:"file-count"};function W(i,o,j,H,c,s){const v=t("ArrowLeft"),u=t("el-icon"),_=t("el-button"),E=t("Box"),g=t("el-main"),h=t("el-container"),y=t("el-tag"),x=t("el-col");return l(),p("div",M,[e("div",R,[n(h,null,{default:r(()=>[n(g,{style:{"max-width":"1200px",margin:"0 auto"}},{default:r(()=>[e("div",D,[n(_,{onClick:s.goHome,text:"",type:"primary"},{default:r(()=>[n(u,null,{default:r(()=>[n(v)]),_:1}),o[0]||(o[0]=m(" Back to releases ",-1))]),_:1},8,["onClick"])]),e("div",U,[e("div",K,[n(u,{size:"32",class:"package-icon"},{default:r(()=>[n(E)]),_:1}),e("div",O,[e("h1",null,d(c.packageInfo.displayName),1)])]),e("div",z,[n(_,{type:"primary",onClick:s.viewLatest,icon:s.View},{default:r(()=>[...o[1]||(o[1]=[m(" Latest ",-1)])]),_:1},8,["onClick","icon"])])])]),_:1})]),_:1})]),n(g,{class:"main-content"},{default:r(()=>[n(x,null,{default:r(()=>[o[3]||(o[3]=e("h4",null,"Releases",-1)),e("div",B,[(l(!0),p(b,null,A(c.packageInfo.versions,a=>(l(),p("div",{key:a.version,class:"version-item",onClick:$=>s.navigateToVersion(a.version)},[e("div",V,[e("div",Y,[e("strong",null,d(a.version),1),a.version===c.packageInfo.latestVersion?(l(),w(y,{key:0,size:"small",type:"success"},{default:r(()=>[...o[2]||(o[2]=[m("Latest ",-1)])]),_:1})):T("",!0)]),e("div",L,[e("span",F,d(s.formatDate(a.date)),1),e("span",P,d(a.files?.length||0)+" files",1)])])],8,G))),128))])]),_:1})]),_:1})])}const J=S(N,[["render",W],["__scopeId","data-v-697914cb"]]);export{J as default};
