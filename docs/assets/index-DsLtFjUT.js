...
`}},async created(){},methods:{goHome(){this.$router.push("/")},navigateToVersion(i){this.$router.push(`/${this.packageInfo.name}/${i}`)},viewLatest(){this.navigateToVersion(this.packageInfo.latestVersion)},formatDate(i){return new Date(i).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"})}}},M={class:"package-page"},R={class:"package-header"},D={class:"header-nav"},U={class:"header-content"},K={class:"package-info"},z={class:"package-details"},O={class:"package-actions"},B={class:"version-list"},G=["onClick"],V={class:"version-info"},Y={class:"version-header"},L={class:"version-meta"},F={class:"version-date"},P={class:"file-count"};function W(i,o,j,H,c,a){const v=t("ArrowLeft"),u=t("el-icon"),_=t("el-button"),E=t("Box"),g=t("el-main"),h=t("el-container"),y=t("el-tag"),k=t("el-col");return d(),p("div",M,[e("div",R,[n(h,null,{default:r(()=>[n(g,{style:{"max-width":"1200px",margin:"0 auto"}},{default:r(()=>[e("div",D,[n(_,{onClick:a.goHome,text:"",type:"primary"},{default:r(()=>[n(u,null,{default:r(()=>[n(v)]),_:1}),o[0]||(o[0]=m(" Back to releases ",-1))]),_:1},8,["onClick"])]),e("div",U,[e("div",K,[n(u,{size:"32",class:"package-icon"},{default:r(()=>[n(E)]),_:1}),e("div",z,[e("h1",null,l(c.packageInfo.displayName),1)])]),e("div",O,[n(_,{type:"primary",onClick:a.viewLatest,icon:a.View},{default:r(()=>[...o[1]||(o[1]=[m(" Latest ",-1)])]),_:1},8,["onClick","icon"])])])]),_:1})]),_:1})]),n(g,{class:"main-content"},{default:r(()=>[n(k,null,{default:r(()=>[o[3]||(o[3]=e("h4",null,"Releases",-1)),e("div",B,[(d(!0),p(b,null,A(c.packageInfo.versions,s=>(d(),p("div",{key:s.version,class:"version-item",onClick:Z=>a.navigateToVersion(s.version)},[e("div",V,[e("div",Y,[e("strong",null,l(s.version),1),s.version===c.packageInfo.latestVersion?(d(),w(y,{key:0,size:"small",type:"success"},{default:r(()=>[...o[2]||(o[2]=[m("Latest ",-1)])]),_:1})):T("",!0)]),e("div",L,[e("span",F,l(a.formatDate(s.date)),1),e("span",P,l(s.files?.length||0)+" files",1)])])],8,G))),128))])]),_:1})]),_:1})])}const J=x(N,[["render",W],["__scopeId","data-v-e6e72bdb"]]);export{J as default};
