import{_ as k,d as A,a as I,b as D,c as M,r as a,e as m,f as e,g as o,w as s,h as f,t as i,i as R,o as u,F as N,j as z}from"./app-BvsYSiLn.js";import{M as T}from"./MarkdownRenderer-DyOXLs1l.js";import{J as U}from"./jszip.min-BWiF4qsh.js";const B={name:"VersionPage",components:{ArrowLeft:M,Box:D,Download:I,Document:A,MarkdownRenderer:T},data(){return{packageInfo:{name:"gold",displayName:"gold",description:""},versionInfo:{version:"v1.0.0",date:"2025-10-25T05:50:56.942Z",files:[{name:"README.md",key:"gold/v1.0.0/README.md",size:3997,lastModified:"2025-10-25T05:28:12.231Z",downloadUrl:"https://rustfs.k88936.top/software-release/gold/v1.0.0/README.md"},{name:"gold",key:"gold/v1.0.0/gold",size:4983336,lastModified:"2025-10-25T05:50:56.942Z",downloadUrl:"https://rustfs.k88936.top/software-release/gold/v1.0.0/gold"},{name:"gold.exe",key:"gold/v1.0.0/gold.exe",size:3712e3,lastModified:"2025-10-25T05:28:11.271Z",downloadUrl:"https://rustfs.k88936.top/software-release/gold/v1.0.0/gold.exe"}]},readme:`# Gold - Release Management Tool\r
\r
...
`}},computed:{totalSize(){return this.versionInfo.files?.reduce((r,n)=>r+n.size,0)||0}},async created(){},methods:{goBack(){this.$router.push(`/${this.packageInfo.name}`)},async downloadAllAsZip(){if(!this.versionInfo.files||this.versionInfo.files.length===0)return;const r=new U;await Promise.all(this.versionInfo.files.map(async c=>{try{const d=await(await fetch(c.downloadUrl)).blob();r.file(c.name,d)}catch{}}));const n=await r.generateAsync({type:"blob"}),l=document.createElement("a");l.href=URL.createObjectURL(n),l.download=`${this.packageInfo.displayName||"assets"}-${this.versionInfo.version||""}.zip`,document.body.appendChild(l),l.click(),document.body.removeChild(l),URL.revokeObjectURL(l.href)},formatDate(r){return new Date(r).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})},formatSize(r){if(r===0)return"0 B";const n=1024,l=["B","KB","MB","GB"],c=Math.floor(Math.log(r)/Math.log(n));return parseFloat((r/Math.pow(n,c)).toFixed(2))+" "+l[c]}}},K={class:"version-page"},O={class:"version-header"},G={class:"header-nav"},Y={class:"header-content"},F={class:"version-info"},L={class:"version-details"},P={class:"release-info"},Z={class:"version-actions"},W={class:"content-section"},j={class:"assets-list"},V={class:"asset-info"},H={class:"asset-details"},J={class:"asset-name"},q={class:"asset-meta"},Q={class:"asset-actions"},X=["href"],$={key:0,class:"readme-section"},ee={class:"sidebar"},ne={class:"info-list"},oe={class:"info-item"},re={class:"info-item"},se={class:"info-value"},te={class:"info-item"},ae={class:"info-value"},ie={class:"info-item"},le={class:"info-value"};function de(r,n,l,c,t,d){const E=a("ArrowLeft"),_=a("el-icon"),g=a("el-button"),y=a("Box"),v=a("el-main"),S=a("el-container"),b=a("Document"),w=a("MarkdownRenderer"),h=a("el-col"),x=a("el-tag"),C=a("el-row");return u(),m("div",K,[e("div",O,[o(S,null,{default:s(()=>[o(v,{style:{"max-width":"1200px",margin:"0 auto"}},{default:s(()=>[e("div",G,[o(g,{onClick:d.goBack,text:"",type:"primary"},{default:s(()=>[o(_,null,{default:s(()=>[o(E)]),_:1}),f(" "+i(t.packageInfo.displayName),1)]),_:1},8,["onClick"])]),e("div",Y,[e("div",F,[o(_,{size:"32",class:"version-icon"},{default:s(()=>[o(y)]),_:1}),e("div",L,[e("h1",null,i(t.packageInfo.displayName)+" "+i(t.versionInfo.version),1),e("p",P,"Released on "+i(d.formatDate(t.versionInfo.date)),1)])]),e("div",Z,[o(g,{type:"primary",onClick:d.downloadAllAsZip,icon:r.Download},{default:s(()=>[...n[0]||(n[0]=[f(" Download All as ZIP ",-1)])]),_:1},8,["onClick","icon"])])])]),_:1})]),_:1})]),o(v,{class:"main-content"},{default:s(()=>[o(C,{gutter:20},{default:s(()=>[o(h,{span:16},{default:s(()=>[e("div",W,[n[3]||(n[3]=e("h3",null,"Artifact",-1)),e("div",j,[(u(!0),m(N,null,z(t.versionInfo.files,p=>(u(),m("div",{key:p.name,class:"asset-item"},[e("div",V,[o(_,{size:"16",class:"asset-icon"},{default:s(()=>[o(b)]),_:1}),e("div",H,[e("div",J,i(p.name),1),e("div",q,i(d.formatSize(p.size)),1)])]),e("div",Q,[e("a",{href:p.downloadUrl,target:"_blank",rel:"noopener"},[o(g,{size:"small",icon:r.Download},{default:s(()=>[...n[1]||(n[1]=[f(" Download ",-1)])]),_:1},8,["icon"])],8,X)])]))),128))]),t.readme?(u(),m("div",$,[n[2]||(n[2]=e("h3",null,"Documentation",-1)),o(w,{content:t.readme,"empty-message":"No documentation available"},null,8,["content"])])):R("",!0)])]),_:1}),o(h,{span:8},{default:s(()=>[e("div",ee,[n[8]||(n[8]=e("h4",null,"Release Information",-1)),e("div",ne,[e("div",oe,[n[4]||(n[4]=e("span",{class:"info-label"},"Version",-1)),o(x,{type:"primary"},{default:s(()=>[f(i(t.versionInfo.version),1)]),_:1})]),e("div",re,[n[5]||(n[5]=e("span",{class:"info-label"},"Release Date",-1)),e("span",se,i(d.formatDate(t.versionInfo.date)),1)]),e("div",te,[n[6]||(n[6]=e("span",{class:"info-label"},"Total Files",-1)),e("span",ae,i(t.versionInfo.files?.length||0),1)]),e("div",ie,[n[7]||(n[7]=e("span",{class:"info-label"},"Total Size",-1)),e("span",le,i(d.formatSize(d.totalSize)),1)])])])]),_:1})]),_:1})]),_:1})])}const fe=k(B,[["render",de],["__scopeId","data-v-109f022b"]]);export{fe as default};
