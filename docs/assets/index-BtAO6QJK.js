import{_ as S,v as f,b as k,c as C,r as t,e as p,o as l,f as e,g as n,w as r,h as m,t as d,F as b,j as A,p as w,i as T}from"./index-CoHSCJZ5.js";import{M as I}from"./MarkdownRenderer-CiPR-VtB.js";const N={name:"PackagePage",computed:{View(){return f}},components:{ArrowLeft:C,Box:k,View:f,MarkdownRenderer:I},data(){return{packageInfo:{name:"gold",displayName:"gold",description:"",latestVersion:"v1.0.0",versions:[{version:"v1.0.0",date:"2025-08-13T04:48:52.285Z",files:[{name:"README.md",key:"gold/v1.0.0/README.md",size:3997,lastModified:"2025-08-13T04:48:52.285Z",downloadUrl:"https://rustfs.k88936.top/software-release/gold/v1.0.0/README.md"},{name:"gold.exe",key:"gold/v1.0.0/gold.exe",size:3734016,lastModified:"2025-08-13T04:48:52.250Z",downloadUrl:"https://rustfs.k88936.top/software-release/gold/v1.0.0/gold.exe"}]}]},readme:`# Gold - Release Management Tool\r
\r
...
`}},async created(){},methods:{goHome(){this.$router.push("/")},navigateToVersion(i){this.$router.push(`/${this.packageInfo.name}/${i}`)},viewLatest(){this.navigateToVersion(this.packageInfo.latestVersion)},formatDate(i){return new Date(i).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"})}}},M={class:"package-page"},R={class:"package-header"},D={class:"header-nav"},U={class:"header-content"},K={class:"package-info"},O={class:"package-details"},z={class:"package-actions"},B={class:"version-list"},G=["onClick"],V={class:"version-info"},Y={class:"version-header"},L={class:"version-meta"},F={class:"version-date"},P={class:"file-count"};function W(i,o,j,H,c,a){const v=t("ArrowLeft"),_=t("el-icon"),u=t("el-button"),E=t("Box"),g=t("el-main"),h=t("el-container"),y=t("el-tag"),x=t("el-col");return l(),p("div",M,[e("div",R,[n(h,null,{default:r(()=>[n(g,{style:{"max-width":"1200px",margin:"0 auto"}},{default:r(()=>[e("div",D,[n(u,{onClick:a.goHome,text:"",type:"primary"},{default:r(()=>[n(_,null,{default:r(()=>[n(v)]),_:1}),o[0]||(o[0]=m(" Back to releases ",-1))]),_:1,__:[0]},8,["onClick"])]),e("div",U,[e("div",K,[n(_,{size:"32",class:"package-icon"},{default:r(()=>[n(E)]),_:1}),e("div",O,[e("h1",null,d(c.packageInfo.displayName),1)])]),e("div",z,[n(u,{type:"primary",onClick:a.viewLatest,icon:a.View},{default:r(()=>o[1]||(o[1]=[m(" Latest ",-1)])),_:1,__:[1]},8,["onClick","icon"])])])]),_:1})]),_:1})]),n(g,{class:"main-content"},{default:r(()=>[n(x,null,{default:r(()=>[o[3]||(o[3]=e("h4",null,"Releases",-1)),e("div",B,[(l(!0),p(b,null,A(c.packageInfo.versions,s=>(l(),p("div",{key:s.version,class:"version-item",onClick:$=>a.navigateToVersion(s.version)},[e("div",V,[e("div",Y,[e("strong",null,d(s.version),1),s.version===c.packageInfo.latestVersion?(l(),w(y,{key:0,size:"small",type:"success"},{default:r(()=>o[2]||(o[2]=[m("Latest ",-1)])),_:1,__:[2]})):T("",!0)]),e("div",L,[e("span",F,d(a.formatDate(s.date)),1),e("span",P,d(s.files?.length||0)+" files",1)])])],8,G))),128))])]),_:1,__:[3]})]),_:1})])}const J=S(N,[["render",W],["__scopeId","data-v-a9e87105"]]);export{J as default};
