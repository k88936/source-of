...
`}},async created(){},methods:{goHome(){this.$router.push("/")},navigateToVersion(l){this.$router.push(`/${this.packageInfo.name}/${l}`)},viewLatest(){this.navigateToVersion(this.packageInfo.latestVersion)},formatDate(l){return new Date(l).toLocaleDateString("en-US",{year:"numeric",month:"short",day:"numeric"})}}},I={class:"package-page"},L={class:"package-header"},T={class:"header-nav"},R={class:"header-content"},V={class:"package-info"},N={class:"package-details"},P={class:"package-actions"},z={class:"version-list"},G=["onClick"],H={class:"version-info"},O={class:"version-header"},j={class:"version-meta"},F={class:"version-date"},W={class:"file-count"};function Z(l,s,U,Y,c,a){const _=o("ArrowLeft"),m=o("el-icon"),h=o("el-button"),b=o("Box"),g=o("el-main"),v=o("el-container"),k=o("el-tag"),w=o("el-col");return r(),p("div",I,[e("div",L,[n(v,null,{default:t(()=>[n(g,null,{default:t(()=>[e("div",T,[n(h,{onClick:a.goHome,text:"",type:"primary"},{default:t(()=>[n(m,null,{default:t(()=>[n(_)]),_:1}),s[0]||(s[0]=u(" Back to releases ",-1))]),_:1,__:[0]},8,["onClick"])]),e("div",R,[e("div",V,[n(m,{size:"32",class:"package-icon"},{default:t(()=>[n(b)]),_:1}),e("div",N,[e("h1",null,d(c.packageInfo.displayName),1)])]),e("div",P,[n(h,{type:"primary",onClick:a.viewLatest,icon:a.View},{default:t(()=>s[1]||(s[1]=[u(" Latest ",-1)])),_:1,__:[1]},8,["onClick","icon"])])])]),_:1})]),_:1})]),n(g,{class:"main-content"},{default:t(()=>[n(w,null,{default:t(()=>[s[3]||(s[3]=e("h4",null,"Releases",-1)),e("div",z,[(r(!0),p(B,null,D(c.packageInfo.versions,i=>(r(),p("div",{key:i.version,class:"version-item",onClick:q=>a.navigateToVersion(i.version)},[e("div",H,[e("div",O,[e("strong",null,d(i.version),1),i.version===c.packageInfo.latestVersion?(r(),M(k,{key:0,size:"small",type:"success"},{default:t(()=>s[2]||(s[2]=[u("Latest ",-1)])),_:1,__:[2]})):E("",!0)]),e("div",j,[e("span",F,d(a.formatDate(i.date)),1),e("span",W,d(i.files?.length||0)+" files",1)])])],8,G))),128))])]),_:1,__:[3]})]),_:1})])}const $=y(A,[["render",Z],["__scopeId","data-v-3afcc325"]]);export{$ as default};
