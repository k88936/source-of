...
export default {
  ...
  data() {
    return {
      ...
      versionInfo: {
      "version": "v1.45",
      "date": "2025-09-23T06:57:20.503Z",
      "files": [
            {
                  "name": "IsoPix_1.4.5.apk",
                  "key": "IsoPix/v1.45/IsoPix_1.4.5.apk",
                  "size": 973682,
                  "lastModified": "2025-09-23T06:57:20.503Z",
                  "downloadUrl": "https://rustfs.k88936.top/software-release/IsoPix/v1.45/IsoPix_1.4.5.apk"
            }
      ]
},
      readme: null
