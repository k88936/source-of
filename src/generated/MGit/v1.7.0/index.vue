...
export default {
  ...
  data() {
    return {
      ...
      versionInfo: {
      "version": "v1.7.0",
      "date": "2025-09-23T06:57:55.599Z",
      "files": [
            {
                  "name": "MGit_1.7.0.apk",
                  "key": "MGit/v1.7.0/MGit_1.7.0.apk",
                  "size": 10936001,
                  "lastModified": "2025-09-23T06:57:55.599Z",
                  "downloadUrl": "https://rustfs.k88936.top/software-release/MGit/v1.7.0/MGit_1.7.0.apk"
            }
      ]
},
      readme: null
