  ...
  data() {
    return {
      ...
      "versions": [
            {
                  "version": "v1.3.4",
                  "date": "2025-08-11T18:03:40.992Z",
                  "files": [
                        {
                              "name": "BOOTICE_v1.3.4_x64_汉化单文件版.exe",
                              "key": "Bootice/v1.3.4/BOOTICE_v1.3.4_x64_汉化单文件版.exe",
                              "size": 501248,
                              "lastModified": "2025-08-11T18:03:40.992Z",
                              "downloadUrl": "https://rustfs.k88936.top/software-release/Bootice/v1.3.4/BOOTICE_v1.3.4_x64_汉化单文件版.exe"
                        }
                  ]
            }
      ]
