...
export default {
  ...
  data() {
    return {
      ...
      versionInfo: {
      "version": "v1.11.4",
      "date": "2025-09-23T06:59:43.353Z",
      "files": [
            {
                  "name": "Z-Lib_1.11.4.apk",
                  "key": "Z-Lib/v1.11.4/Z-Lib_1.11.4.apk",
                  "size": 33076250,
                  "lastModified": "2025-09-23T06:59:43.353Z",
                  "downloadUrl": "https://rustfs.k88936.top/software-release/Z-Lib/v1.11.4/Z-Lib_1.11.4.apk"
            }
      ]
},
      readme: null
